...
const NewtonCradleTop = () => {
  return (
    <div className="absolute base:overflow-hidden xs:overflow-visible w-[110%] xs:w-auto scale-90 top-28 md:top-48 transform left-1/2 -translate-x-1/2 -translate-y-1/2">
